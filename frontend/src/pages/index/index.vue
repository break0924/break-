...
function teamFlag(team?: { flagUrl?: string | null; countryCode?: string | null } | null) {
  if (team?.flagUrl) {
    return team.flagUrl;
  }
  return team?.countryCode ? `/static/flags/${team.countryCode}.svg` : '/static/flags/default.svg';
}
